          ...
          <div className="space-y-4">
            {credentials.map((credential) => (
              <div
                ...
                className="flex items-start gap-4 p-5 rounded-xl bg-card shadow-soft hover:shadow-card transition-all duration-300 group"
              >
          ...
          <div className="flex flex-col">
            <div className="relative mb-4">
              ...
              <img
                ...
                className="relative w-full aspect-[4/3] rounded-2xl shadow-elevated object-cover object-top"
              />
            </div>
